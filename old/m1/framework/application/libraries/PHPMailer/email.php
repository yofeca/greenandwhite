...
include_once(dirname(__DIR__)."/PHPMailer/class.smtp.php");
include_once(dirname(__DIR__)."/PHPMailer/class.phpmailer.php");
include_once(dirname(__DIR__)."/PHPMailer/config.php");
