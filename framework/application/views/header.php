...
<html lang="en">
    <head>
        ...
        ?>
		<link rel="icon" type="image/png" href="<?php echo base_url('media/img/favicon.ico'); ?>" />
            ...
            <div class="container hidden-sm hidden-xs">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6">
						<form action="<?php echo base_url('page/search_page_result'); ?>" method="get" role="form">
							<div class="input-group">
								<input type="text" name="k" class="form-control input-sm sbox-text" placeholder="Search..." value="<?php if(isset($_GET['k'])) echo $_GET['k']; ?>">
								<span class="input-group-btn">
									<button class="btn btn-default btn-sm sbox-button" type="submit">
